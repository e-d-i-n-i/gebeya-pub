...
import 'package:gebeya_ecommerce_application/common/widgets/chips/choice_chip.dart';
        ...
        TRoundedContainer(
          ...
          child: Column(
            children: [
              ...
              const TProductTitleText(
                title:
                    'This is the Description of the Prduct and it can go up to max 4 lines.',
                smallSize: true,
                maxLines: 4,
              ), // TProductTitleText
            ],
